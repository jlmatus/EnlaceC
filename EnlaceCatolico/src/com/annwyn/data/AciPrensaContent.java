...
public class AciPrensaContent {
	...
	public static void GetContent (){
       ...
       URL url = null;
		...
		try {
			url = new URL("http://feeds.feedburner.com/noticiasaci?format=fedd&type=rss");
	 ...
	 */
	public static class AciPrensaItem {
		public String id;
		public String title;
		public String content;

		public AciPrensaItem(String id, String title, String content) {
			this.id = id;
			this.title = title;
